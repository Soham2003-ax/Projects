...
# **ML Project based ( Prediction based On High-Value Retail Transactions )**
"""
...
print("Precision:", precision_score(ytest, Logpred))                           # Precision: Out of everything the model said was 1, how many were actually 1
print("Recall:", recall_score(ytest, Logpred))                                 # Recall: Out of all actual 1s, how many did the model correctly find?
print("F1 Score:", f1_score(ytest, Logpred))                                   # F1 score: Balance between precision and recall
...
predict_logi = Log.predict(xtrain)
accuracy_score(ytrain, predict_train)
